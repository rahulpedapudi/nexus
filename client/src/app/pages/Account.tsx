...
import { Bot, Download, AlertTriangle, Check, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <PageTransition className="max-w-2xl space-y-12 pb-24">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Manage your profile, data, and connection settings.</p>
      </div>
      ...
      <div className="space-y-12 divide-y divide-border">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              {isEditingName ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button className="text-sm text-primary hover:underline" onClick={() => setIsEditingName(true)}>
                    Edit
                  </button>
                </div>
              )}
            ...
            <div className="pt-2">
              {isChangingPassword ? (
                <div className="space-y-3 max-w-xs p-4 bg-secondary/50 rounded-lg border border-border">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setIsChangingPassword(false)}>Cancel</Button>
                  </div>
                </div>
              ) : (
        ...
        <section className="space-y-6 pt-12">
          ...
          <div className="flex justify-between items-center bg-card border border-border p-5 rounded-xl">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">Renews on Oct 15, 2026</p>
            </div>
          ...
          <div className="flex items-center justify-between p-5 rounded-xl border border-border bg-card">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground font-mono mt-1">ID: 849302844</p>
              </div>
            </div>
            <Button variant="outline" onClick={() => toast('Nexus bot will stop responding if you disconnect.')}>
              Disconnect
            </Button>
          </div>
        </section>
        ...
        <section className="space-y-6 pt-12">
          ...
          <p className="text-sm text-muted-foreground">
            Nexus is privacy-first. Your data is stored only on your server. You can export a copy of all your expenses, memories, reminders, and activity logs at any time.
          </p>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Clears all memories, expenses, and reminders. Your account and configurations remain.
                </p>
              </div>
              <Button variant="danger" onClick={() => toast.success('Data wipe initiated')}>Wipe Data</Button>
            </div>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-6">
                This action cannot be undone. All your data, settings, and memories will be permanently deleted.
              </p>
