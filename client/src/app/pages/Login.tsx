      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-3xl tracking-wide font-light">Welcome back</h1>
          ...
          <p className="text-sm text-muted-foreground mt-6">
            ...
            <Link to="/setup" className="text-primary hover:text-primary/80 transition-colors font-medium">
              Set up Nexus
            </Link>
          </p>
        </motion.div>
